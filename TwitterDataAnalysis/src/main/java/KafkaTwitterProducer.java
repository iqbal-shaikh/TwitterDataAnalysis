...
public class KafkaTwitterProducer {
	public static void main(String[] args) throws Exception {
		...
		prop.load(new FileInputStream(currentDirectory + "/file.properties"));
		...
		while (true) {
			...
			if (ret == null) {
				...
				for (HashtagEntity hashtage : ret.getHashtagEntities()) {
					...
					String twits = "{\"twits\":\"" + ret.getText().replaceAll("[^a-zA-Z0-9\\r|\\n]", " ") + "\"}";
					producer.send(new ProducerRecord<String, String>(topicName, Integer.toString(j++), twits));
